...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-24">
      <h1 className="text-3xl font-bold text-ink">About CLIP</h1>
      <p className="mt-4 text-slate-600">
        CLIP connects brands who want their content distributed with a network of creators who
        publish it and get paid on verified, qualified performance — not vanity views. We built
        CLIP because influencer marketing shouldn&apos;t require an agency, and creator payouts
      ...
      <p className="mt-4 text-slate-600">
        ...
        <a href="/how-it-works" className="text-brand-600 hover:underline">How CLIP Works</a>.
      </p>
    </main>
  );
}
