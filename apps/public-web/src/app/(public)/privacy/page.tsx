...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-24">
      ...
      <p className="mt-2 text-sm text-slate-400">Placeholder — needs legal review before this reflects a real, launchable policy.</p>
      ...
      <div className="mt-8 space-y-6 text-sm text-slate-600">
        ...
        <section>
          <h2 className="font-semibold text-ink">Instagram data</h2>
