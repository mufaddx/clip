...
// notification preferences and account actions, kept as clearly separated
// rows rather than one undifferentiated card.
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Your company name, industry, and targeting categories live on your{" "}
                <Link href="/profile" className="text-brand-600 hover:underline">profile</Link>. Teammate access is
                managed under <Link href="/team" className="text-brand-600 hover:underline">Team Members</Link>.
              </p>
            </div>
          </div>
        </Card>
